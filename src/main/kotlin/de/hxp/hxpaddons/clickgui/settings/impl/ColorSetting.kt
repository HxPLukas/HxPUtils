...
import de.hxp.hxpaddons.utils.Color.Companion.hsbMax
...
import de.hxp.hxpaddons.utils.ui.rendering.Gradient
...
class ColorSetting(
    ...
    override fun render(x: Float, y: Float, mouseX: Float, mouseY: Float): Float {
        ...
        NVGRenderer.hollowRect(x + 6f, y + 212f, width - 12f, 15f, 1f, Colors.controlBg.rgba, 5f)

        val huePos = x + 6f + hueSliderAnim.get(hueSliderPrev, value.hue, false) * (width - 12f) to y + 219f
        ...
        if (allowAlpha) {
            ...
            val alphaPos = Pair((x + 6f + alphaSliderAnim.get(alphaSliderPrev, value.alphaFloat, false) * (width - 12f)), y + 240f)
        ...
        NVGRenderer.rect(rectX, y + actualHeight - 28f, width / 2, 24f, Colors.controlBg.rgba, 4f)
        NVGRenderer.hollowRect(rectX, y + actualHeight - 28f, width / 2, 24f, 2f, ClickGUIModule.clickGUIColor.withAlpha(0.45f).rgba, 4f)
