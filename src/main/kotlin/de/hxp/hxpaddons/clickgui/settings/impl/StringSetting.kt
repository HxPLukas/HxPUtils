...
class StringSetting(
    ...
    override fun render(x: Float, y: Float, mouseX: Float, mouseY: Float): Float {
        ...
        NVGRenderer.rect(rectStartX, y + getHeight() - 35f, width - 12f, 30f, Colors.controlBg.rgba, 4f)
        NVGRenderer.hollowRect(rectStartX, y + getHeight() - 35f, width - 12f, 30f, 1.5f, ClickGUIModule.clickGUIColor.withAlpha(0.45f).rgba, 4f)
