...
object Colors {
    ...
    /**
     * The Click GUI's "glassy" translucent control surface - a soft white wash instead of an opaque
     * solid-gray box, so interactive widgets (sliders, text inputs, chips, ...) read as part of the same
     * dark/amethyst theme as the rest of the redesigned GUI rather than looking like flat gray-blue boxes
     * with a colored outline slapped on top.
     */
    @JvmField val controlBg = Color(255, 255, 255, 0.08f)
    @JvmField val controlBgHover = Color(255, 255, 255, 0.16f)
}