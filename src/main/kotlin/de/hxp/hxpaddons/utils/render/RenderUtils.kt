...
import de.hxp.hxpaddons.mixin.accessors.BeaconBeamAccessor
...
import de.hxp.hxpaddons.utils.unaryMinus
...
fun RenderEvent.Extract.drawBoxes(waypoints: Collection<DungeonWaypoint>, disableDepth: Boolean) {
