...
abstract class GuiEvent(val screen: Screen) : CancellableEvent() {
    ...
    class RenderSlot(screen: Screen, val guiGraphics: GuiGraphicsExtractor, val slot: Slot, val x: Int, val y: Int) : GuiEvent(screen)

    class RenderSlotPost(screen: Screen, val guiGraphics: GuiGraphicsExtractor, val slot: Slot, val x: Int, val y: Int) : GuiEvent(screen)
    ...
    class RenderPost(screen: Screen, val guiGraphics: GuiGraphicsExtractor, val mouseX: Int, val mouseY: Int) : GuiEvent(screen)
}